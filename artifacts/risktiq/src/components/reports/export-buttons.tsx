  ...
  return (
    <div className="flex flex-col gap-3">
      <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
        <Button type="button" variant="secondary" onClick={() => handleDownload("pdf")} disabled={downloadingFormat !== null}>
          <FileText className="h-4 w-4" />
          {downloadingFormat === "pdf" ? "Preparing PDF..." : "Export PDF"}
        </Button>
        <Button type="button" variant="secondary" onClick={() => handleDownload("word")} disabled={downloadingFormat !== null}>
          <Files className="h-4 w-4" />
          {downloadingFormat === "word" ? "Preparing Word..." : "Export Word"}
        </Button>
        <Button type="button" variant="secondary" onClick={() => handleDownload("excel")} disabled={downloadingFormat !== null}>
