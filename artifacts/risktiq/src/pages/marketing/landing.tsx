...
const features = [
  { title: "Private trader workspaces", description: "Every account has fully isolated data, protected auth, and secure trade records.", icon: ShieldCheck },
  { title: "Discipline intelligence", description: "Track overtrading, revenge sessions, emotional execution, and rule breaks in real time.", icon: Target },
  { title: "Strategy analytics", description: "See which setups actually scale, where losses cluster, and what deserves more capital.", icon: BarChart3 },
  { title: "AI habit coaching", description: "Receive habit analysis, reflection prompts, and improvement suggestions based on your behavior.", icon: BrainCircuit },
];
...
const workflows = [
  { title: "Capture every trade", description: "Log entries, exits, screenshots, emotions, mistakes, and lessons in one structured flow.", icon: CandlestickChart },
  { title: "Audit your discipline", description: "Track overtrading, revenge entries, streak breakdowns, and rule violations automatically.", icon: Radar },
  { title: "Scale what works", description: "See your strongest strategies, month-over-month growth, and the habits that actually improve PnL.", icon: BriefcaseBusiness },
];
        ...
        <div className="grid gap-12 xl:grid-cols-[0.92fr_1.08fr] xl:items-start">
          <div className="space-y-8 pt-4">
            ...
            <div className="grid gap-3 text-sm text-muted-foreground md:grid-cols-2">
              {highlights.map((item) => (
                <div key={item} className="flex items-start gap-3 rounded-2xl border border-border/50 bg-card/60 p-4 shadow-[0_12px_32px_rgba(15,23,42,0.05)]">
            ...
            <div className="grid gap-6 p-6 md:p-8">
              ...
              <div className="rounded-[24px] border border-border/60 bg-background/80 p-6">
                ...
                <p className="mt-4 text-sm text-muted-foreground">
                  The homepage now reflects the actual product promise: a serious trading workspace, not a static brochure.
                </p>
              </div>
            </div>
          </Card>
