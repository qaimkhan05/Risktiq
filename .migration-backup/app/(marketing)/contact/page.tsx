...
export const metadata: Metadata = {
  title: "Contact | Risktiq",
  description: "Contact the Risktiq team for product support, account help, or partnerships."
};
...
const contactCards = [
  {
    ...
    description: "Get help with account access, journaling issues, exports, or dashboard behavior.",
    icon: Headset
  },
  {
    title: "Fast response path",
    description: "Use the form for structured requests so support can respond with the right context quickly.",
    icon: Clock3
  },
  {
    title: "Private by design",
    description: "Your account and journal data stay isolated. Support only reviews what you explicitly report.",
    icon: ShieldCheck
  }
];
        ...
        <div className="grid gap-8 xl:grid-cols-[0.92fr_1.08fr]">
          <div className="space-y-6">
            ...
            <Card className="p-6">
              ...
              <p className="mt-4 text-sm leading-7 text-muted-foreground">
                For deployment-specific help, include your Vercel project URL, the issue you saw, and the screen where
                it happened.
              </p>
            </Card>
          </div>
          ...
          <Card className="p-6 md:p-8">
            ...
            <p className="mt-3 max-w-2xl text-sm leading-7 text-muted-foreground">
              Reach out if you need help with account verification, export issues, screenshots, admin access, or Vercel
              deployment setup.
            </p>
            <div className="mt-8">
